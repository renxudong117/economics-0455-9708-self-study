...
#### 知识点 01/04｜PPC 是约束图，不是需求供给图｜Concept development
...
#### 知识点 02/04｜机会成本、曲率与偏向性移动｜Concept development
...
A production possibility curve shows the maximum attainable combinations of two products when resources and technology are fixed. Productive efficiency concerns whether output is maximised; allocative efficiency concerns whether the chosen mix matches society's preferences. An outward shift indicates an increase in productive potential, but actual output will rise only if the additional capacity is used.

#### 知识点 04/04｜真题化知识应用｜Concept development

常见图题给出 recession、training、natural disaster 或资源从消费品转向资本品。Recession 通常使经济从曲线上点移到曲线内；training 使 PPC 外移；灾害使其内移；更多 capital goods 会降低当前 consumer goods，却可能使未来 PPC 外移更快。答图时依次写 axis labels、PPC1/PPC2、arrow 和原因。
